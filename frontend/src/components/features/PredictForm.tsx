...
export const PredictForm: React.FC<PredictFormProps> = ({ onSubmit, isLoading }) => {
    ...
    const onFormSubmit = (data: FormData) => {
        onSubmit(data as CustomerInput); // Cast is safe due to schema match
    };
    ...
    return (
        <Card className="w-full max-w-2xl mx-auto shadow-sm border-border">
            <CardHeader>
                ...
                <CardDescription>
                    Enter customer metrics to generate a real-time risk assessment and explanation.
                </CardDescription>
            </CardHeader>
            <form onSubmit={handleSubmit(onFormSubmit)}>
                <CardContent className="grid gap-6 md:grid-cols-2">
                    ...
                    <div className="space-y-2">
                        ...
                        />
                        {errors.Geography && <p className="text-xs text-destructive">{errors.Geography.message}</p>}
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <Input type="number" step="0.01" id="Balance" {...register("Balance")} />
                    ...
                    <div className="space-y-2">
                        ...
                        <Input type="number" id="NumOfProducts" {...register("NumOfProducts")} />
                        {errors.NumOfProducts && <p className="text-xs text-destructive">{errors.NumOfProducts.message}</p>}
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        />
                        {errors.CardType && <p className="text-xs text-destructive">{errors.CardType.message}</p>}
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        />
                        {errors.HasCrCard && <p className="text-xs text-destructive">{errors.HasCrCard.message}</p>}
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        />
                        {errors.IsActiveMember && <p className="text-xs text-destructive">{errors.IsActiveMember.message}</p>}
                    </div>

                    {/* Estimated Salary */}
                    <div className="space-y-2">
                        <Label htmlFor="EstimatedSalary">Estimated Salary</Label>
                        <Input type="number" step="1000" id="EstimatedSalary" {...register("EstimatedSalary")} />
                        {errors.EstimatedSalary && <p className="text-xs text-destructive">{errors.EstimatedSalary.message}</p>}
                    </div>
