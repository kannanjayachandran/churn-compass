...
import { UploadCloud, FileType, CheckCircle, AlertCircle, Loader2, ArrowLeft, BarChart3, Users, AlertTriangle } from 'lucide-react';
...
export const UploadForm: React.FC = () => {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            // 1. Trigger download (keep existing behavior)
            ...
            // 2. Parse blob for visualization
            ...
            console.error(error);
            const msg = error.response?.data?.detail || "Upload failed. Check format.";
            setErrorMessage(msg);
            setStatus("error");
        } finally {
            setIsLoading(false);
        ...
        return (
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="flex items-center justify-between">
                    <div>
                        <h2 className="text-2xl font-bold tracking-tight">Batch Analysis Complete</h2>
                        <p className="text-muted-foreground">Scored {total} customers from {file?.name}</p>
                    </div>
                ...
                <div className="grid gap-4 md:grid-cols-3">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">{highRisk + mediumRisk}</div>
                ...
                <div className="grid gap-4 grid-cols-1">
                    <Card className="col-span-1">
                        <CardHeader>
                            ...
                            <CardDescription>Breakdown of customer base by churn risk level</CardDescription>
                        </CardHeader>
            ...
            <CardContent>
                ...
                >
                    ...
                    {file ? (
                        ...
                        <div className="flex flex-col items-center gap-2">
                            ...
                            <p className="font-medium text-muted-foreground">Click to upload CSV</p>
                ...
                {status === "success" && (
                    <div className="mt-4 flex items-center gap-2 text-green-600 bg-green-50 p-3 rounded-md">
                        ...
                        <span className="text-sm font-medium">Predictions downloaded successfully</span>
                    </div>
                )}
